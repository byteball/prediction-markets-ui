...
export const Footer = () => {
  ...
  return <div className={styles.wrap}>
    ...
    <div className={styles.disclaimer}>
      The Prophet.ooo website (“Site”) is for informational and educational purposes only. The Site displays existing markets deployed on the Obyte DAG and is a graphical user interface for both visualizing data from on-chain activity and interacting with autonomous agents directly from your own wallets. 
