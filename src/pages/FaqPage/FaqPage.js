...
export const FaqPage = () => {
  ...
  return (<Layout>
    ...
    <div className="faq">
      ...
      >
        <Panel header={t("pages.faq.items.1.question", "Who is this site for?")} key="1">
        ...
        <Panel header={t("pages.faq.items.2.question", "How do bettors make money?")} key="2">
        ...
        <Panel header={t("pages.faq.items.3.question", "How do liquidity providers make money?")} key="3">
        ...
        <Panel header={t("pages.faq.items.4.question", "I made a bet and now I changed my mind. Can I exit the bet?")} key="4">
        ...
        <Panel header={t("pages.faq.items.5.question", "When can I make/exit my bets?")} key="5">
        ...
        <Panel header={t("pages.faq.items.6.question", "Is in-game trading allowed?")} key="6">
        ...
        <Panel header={t("pages.faq.items.7.question", "What are the fees?")} key="7">
        ...
        <Panel header={t("pages.faq.items.8.question", "Are token prices equal to the probabilities that the market believes?")} key="8">
        ...
        <Panel header={t("pages.faq.items.12.question", "What are the sources of data about outcomes?")} key="12">
        ...
        <Panel header={t("pages.faq.items.13.question", "My prediction won, how do I get my payout?")} key="13">
        ...
        <Panel header={t("pages.faq.items.14.question", "What is 'Resumed trading' state?")} key="14">
        ...
        <Panel header={t("pages.faq.items.15.question", "Can I make bets if I have no funds on Obyte?")} key="15">
        ...
        <Panel header={t("pages.faq.items.16.question", "What format of odds do you display on the website?")} key="16">
